...
type Config$15 = Plugin.Name<'@angular/common'> & Plugin.Hooks & IndexExportOption & {
  /**
   * Options for generating HTTP Request instances.
   */
...
type AngularCommonPlugin = DefinePlugin<UserConfig$24, Config$15>;
//#endregion
...
type Config$14 = Plugin.Name<'@faker-js/faker'> & Plugin.Hooks & IndexExportOption & {
  // Resolvers & {
  /**
   * Casing convention for generated names.
   */
...
type FakerJsFakerPlugin = DefinePlugin<UserConfig$23, Config$14, IApi$4>;
//#endregion
...
declare namespace Plugin {
  ...
  export type Types<Config$16 extends BaseConfig = BaseConfig, ResolvedConfig extends BaseConfig = Config$16, Api extends BaseApi = never> = ([Api] extends [never] ? {
    api?: BaseApi;
  } : {
    api: Api;
  }) & {
...
type DefinePlugin<Config$16 extends BaseConfig = BaseConfig, ResolvedConfig extends BaseConfig = Config$16, Api extends BaseApi = never> = {
  Config: Plugin.Config<Plugin.Types<Config$16, ResolvedConfig, Api>>;
  Handler: (args: {
    plugin: PluginInstance<Plugin.Types<Config$16, ResolvedConfig, Api>>;
  }) => void;
  Instance: PluginInstance<Plugin.Types<Config$16, ResolvedConfig, Api>>;
  Types: Plugin.Types<Config$16, ResolvedConfig, Api>;
};
//#endregion
