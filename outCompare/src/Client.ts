...
export class Client {
	...
	public readonly aksjonspunkt: AksjonspunktService;
	public readonly aktoer: AktoerService;
	public readonly arbeidsgiver: ArbeidsgiverService;
	public readonly behandlingÅrskvantumUttak: BehandlingÅrskvantumUttakService;
	public readonly behandlingÅrskvantumUttrekk: BehandlingÅrskvantumUttrekkService;
	public readonly behandlinger: BehandlingerService;
	public readonly behandlingFosterbarn: BehandlingFosterbarnService;
	public readonly behandlingPerson: BehandlingPersonService;
	public readonly behandlingPleiepengerUttak: BehandlingPleiepengerUttakService;
	public readonly behandlingUttak: BehandlingUttakService;
	public readonly behandlingUtvidetRett: BehandlingUtvidetRettService;
	public readonly beregning: BeregningService;
	public readonly beregningsgrunnlag: BeregningsgrunnlagService;
	public readonly beregningsresultat: BeregningsresultatService;
	public readonly brev: BrevService;
	public readonly brukerdialog: BrukerdialogService;
	public readonly default: DefaultService;
	public readonly død: DødService;
	public readonly dokument: DokumentService;
	public readonly fagsak: FagsakService;
	public readonly feriepenger: FeriepengerService;
	public readonly fordel: FordelService;
	public readonly forvaltning: ForvaltningService;
	public readonly forvaltningPerson: ForvaltningPersonService;
	public readonly historikk: HistorikkService;
	public readonly infotrygdmigrering: InfotrygdmigreringService;
	public readonly initFetch: InitFetchService;
	public readonly inntektArbeidYtelse: InntektArbeidYtelseService;
	public readonly integrasjon: IntegrasjonService;
	public readonly journalposter: JournalposterService;
	public readonly kodeverk: KodeverkService;
	public readonly kompletthet: KompletthetService;
	public readonly kontroll: KontrollService;
	public readonly los: LosService;
	public readonly navAnsatt: NavAnsattService;
	public readonly notat: NotatService;
	public readonly omsorgenFor: OmsorgenForService;
	public readonly oppdrag: OppdragService;
	public readonly oppgittOpptjening: OppgittOpptjeningService;
	public readonly opplæringsinstitusjon: OpplæringsinstitusjonService;
	public readonly opplæringspenger: OpplæringspengerService;
	public readonly opptjening: OpptjeningService;
	public readonly perioder: PerioderService;
	public readonly pip: PipService;
	public readonly prosesstask: ProsesstaskService;
	public readonly rapportering: RapporteringService;
	public readonly redirect: RedirectService;
	public readonly registerdata: RegisterdataService;
	public readonly saksnummer: SaksnummerService;
	public readonly søknad: SøknadService;
	public readonly søknadsfrist: SøknadsfristService;
	public readonly sykdom: SykdomService;
	public readonly tilbakekrevingsvalg: TilbakekrevingsvalgService;
	public readonly tilsyn: TilsynService;
	public readonly totrinnskontroll: TotrinnskontrollService;
	public readonly uttak: UttakService;
	public readonly vedtak: VedtakService;
	public readonly vilkår: VilkårService;
	public readonly ytelser: YtelserService;
